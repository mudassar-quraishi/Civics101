...
var NEUTRAL_REDIRECT = "I can help with election processes and how voting works in India, but I stay neutral on parties, candidates, and political positions. Try asking about voter registration, EVMs, how the Lok Sabha works, or what NOTA means!";
function isBlocked(message) {
  return BLOCKED_PATTERNS.some((p) => p.test(message));
}
function searchKB(topicId, message) {
